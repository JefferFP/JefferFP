...
Desarrollador **Backend** con sólida experiencia en el ecosistema Java y entusiasta del **Frontend** moderno con React. Me apasiona construir aplicaciones **robustas, escalables y eficientes**, resolviendo problemas complejos mediante código limpio y buenas prácticas. Siempre estoy en busca de aprender nuevas tecnologías para optimizar procesos y aportar valor en cada proyecto. Actualmente en búsqueda de nuevos desafíos donde pueda seguir creciendo profesionalmente.
...
⭐ **¡Gracias por visitar mi perfil!** Si te interesa colaborar en algún proyecto o simplemente quieres conversar sobre tecnología, no dudes en escribirme.
